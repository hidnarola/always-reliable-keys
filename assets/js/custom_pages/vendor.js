...
***********************************************************/
    $('.datatable-responsive-control-right').dataTable({
        ...
        order: [[1, "asc"]],
        ajax: site_url + 'inventory/get_vendors_data',
        responsive: {
            details: {
                type: 'column',
                target: -1
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, full, meta) {
                    action = '';
                    action += '&nbsp;&nbsp;<a href="' + site_url + 'inventory/vendors/edit/' + btoa(full.id) + '" class="btn custom_dt_action_button btn-xs" title="Edit">Edit</a>';
                    action += '&nbsp;&nbsp;<a href="' + site_url + 'inventory/vendors/delete/' + btoa(full.id) + '" class="btn custom_dt_action_button btn-xs" onclick="return confirm_alert(this)" title="Delete">Delete</a>';
                    return action;
                },
                sortable: false,
            },
    ...
    var add_button = '<div class="text-right"><a href="' + site_url + 'inventory/vendors/add" class="btn bg-teal-400 btn-labeled custom_add_button"><b><i class="icon-plus-circle2"></i></b> Add Vendors</a></div>';
...
***********************************************************/
    var validator = $("#add_vendor_form").validate({
        ...
        rules: {
            ...
            txt_contact_no: { required: true, minlength:10, maxlength:10},
